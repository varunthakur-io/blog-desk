...
const FeatureCard = ({ icon: Icon, title, description }) => (
  <div className="flex flex-col items-center text-center p-7 rounded-xl border border-border/50 bg-card shadow-sm hover:-translate-y-0.5 hover:shadow-md hover:border-border transition-all duration-300">
    <div className="p-3 rounded-xl bg-accent mb-4">
...
const WhyItem = ({ icon: Icon, title, description }) => (
  <div className="flex items-start gap-5">
    <div className="p-2.5 rounded-xl bg-accent shrink-0 mt-0.5">
    ...
    <div className="py-4 animate-in fade-in duration-500">
      ...
      <section className="text-center mb-20 max-w-3xl mx-auto space-y-5">
        ...
        <div className="flex items-center justify-center gap-3 pt-2">
          <Link
            to="/signup"
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground text-sm font-semibold rounded-full px-5 py-2.5 hover:opacity-90 transition-opacity shadow-sm"
          >
      ...
      <section className="max-w-3xl mx-auto mb-20">
        ...
        <div className="space-y-7 p-8 rounded-2xl border border-border/50 bg-card shadow-sm">
          <WhyItem
            icon={Code2}
      ...
      {/* CTA */}
      <section className="text-center max-w-lg mx-auto py-10 px-8 rounded-2xl border border-border/40 bg-accent/40">
        ...
        <Link
          to="/signup"
          className="inline-flex items-center gap-2 bg-primary text-primary-foreground text-sm font-semibold rounded-full px-6 py-2.5 hover:opacity-90 transition-opacity shadow-sm"
        >
