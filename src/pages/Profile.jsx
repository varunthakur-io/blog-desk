          ...
          <section className="space-y-6">
            ...
            <div className="flex items-center gap-6 pt-1">
              <button
                ...
                className="group flex flex-col text-left active:scale-95"
            ...
            <nav className="flex flex-col gap-3 pt-2">
              {isOwner ? (
                <>
                  ...
                  <Button
                    variant="ghost"
                    className="text-muted-foreground hover:text-primary h-9 w-full justify-start px-2 text-xs font-bold"
                    onClick={() => navigate('/settings')}
                  >
