  ...
  return (
    <article className="animate-in fade-in duration-700">
      <div className="flex flex-col items-start gap-16 lg:flex-row">
        ...
        <div className="order-2 w-full min-w-0 flex-1 lg:order-1">
          ...
          <section>
            <header className="flex h-[52px] items-center justify-between pb-1">
              <h2 className="text-foreground text-4xl font-black tracking-tighter">Stories</h2>
            </header>
        ...
        <aside className="border-border/20 sticky top-16 order-2 hidden w-[320px] shrink-0 flex-col gap-10 border-l pl-10 transition-all lg:flex">
          <section className="space-y-6">
            ...
            <div className="space-y-1">
              <h1 className="text-foreground truncate text-xl font-black tracking-tight">{name}</h1>
            ...
            {bio ? (
              <p className="border-primary/10 text-foreground/70 border-l-2 py-1 pl-4 text-[14px] leading-relaxed italic">
                {bio}
              </p>
            ) : (
