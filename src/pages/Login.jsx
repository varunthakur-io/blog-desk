...
const Login = () => {
  return (
    <main className="flex min-h-screen">
      ...
      <section className="relative isolate hidden w-1/2 lg:block">
        ...
        <div className="absolute inset-0 overflow-hidden select-none">
          <img
            ...
            className="absolute inset-0 h-full w-full transform-gpu object-cover transition-transform duration-10000 ease-out backface-hidden hover:scale-110"
          />
        </div>
        ...
        <div className="pointer-events-none absolute inset-0 z-20 flex flex-col justify-end p-12 text-white lg:p-16 xl:p-20">
          <div className="max-w-md space-y-4">
            <h2 className="text-4xl leading-tight font-bold tracking-tight text-white/90 xl:text-5xl">
      ...
      <section className="bg-background flex w-full flex-col items-center justify-center p-6 sm:p-8 lg:w-1/2 lg:p-12 xl:p-20">
