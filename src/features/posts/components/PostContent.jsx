  ...
  return (
    <>
      ...
      <div className="bg-muted/20 fixed top-0 right-0 left-0 z-[100] h-0.5">
        <div
          className="bg-foreground h-full shadow-[0_0_10px_rgba(0,0,0,0.2)] duration-150 ease-out"
