// RecommendedSidebar: suggested content and discovery feed for the home page
...
const RecommendedSidebar = ({
  ...
  <div className="flex min-h-[calc(100vh-10rem)] flex-1 flex-col space-y-12">
    {/* Staff Picks Section */}
          ...
          staffPicks.map((post) => (
            ...
            >
              ...
              {post.coverImageUrl && (
                <Link
                  to={`/posts/${post.$id}`}
                  className="bg-muted border-border/10 size-12 shrink-0 overflow-hidden rounded-md border"
                >
                  <img
